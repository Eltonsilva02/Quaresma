...
const UrgencyBar = () => {
  return (
    <div className="relative w-full z-[60] bg-[#877301] shadow-lg border-b border-white/20 flex flex-col md:flex-row items-center justify-center px-4 py-3 md:py-4 min-h-[60px] gap-2">
